...
public class listDanhSachSv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new danhSachModel("Đinh Hoài Nam", "Thái Bình", "FPoly Hà Nội"));
        list.add(new danhSachModel("Lê Mạnh Quỳnh", "Vĩnh Phúc", "FPoly Hải Phòng"));
        list.add(new danhSachModel("Tống Doanh Chính", "Nam Định", "FPoly Đà Nẵng"));
        list.add(new danhSachModel("Phạm Tiến Minh", "Vĩnh Phúc", "FPoly Tây Nguyên"));
        list.add(new danhSachModel("Phùng Quang Dũng", "Hà Nội", "FPoly Lâm Đồng"));
